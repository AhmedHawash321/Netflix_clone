...
const AuthScreen = () => {
  ...
  return (
    ...
    <div className="flex flex-col items-center justify-center text-center py-40 text-white max-w-6xl mx-auto">
       <h1 className="text-4xl md:text-6xl font-bold mb-4">Unlimtited Movies, Tv Shows, and More</h1>
      ...
      <div className="py-10 bg-black text-white">
        <div className="flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <p className="text-lg md:text-xl">Watch on Smart TVs, PlaStation, Xbox, Chromecast, Apple TV, Blu-ray players, and more.</p>
          </div>
          {/* right side */}
      ...
      <div className="py-10 bg-black text-white">
        <div className="flex max-w-6xl mx-auto items-center justify-center flex-col-reverse md:flex-row px-4 md:px-2">
          ...
          <p className="text-lg md:text-xl">Send Kids On Adventures With Thier Favorite Characters In a Space Made Just for Them-Free With Your Membership.</p>
          </div>
        </div>
