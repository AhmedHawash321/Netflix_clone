...
import { MOVIE_CATEGORIES, TV_CATEGORIES,ORICINAL_IMG_BASE_URL } from "../../utils/constants";
...
const HomeScreen = () => {
  ...
  return (
    ...
    <div className="relative h-screen text-white">
      <Navbar />
      <img 
        src={ORICINAL_IMG_BASE_URL + trendingContent?.backdrop_path} 
        alt="Hero img" 
    ...
    <div className="flex flex-col gab-10 bg-black py-10">
      {contentType === 'movie'  
